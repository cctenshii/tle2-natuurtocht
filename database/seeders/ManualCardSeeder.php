        ...
        DB::transaction(function () {
            ...
            $cardsData = [
                ...
                [
                    ...
                    'category' => 'Plant',
                    'season_text' => 'Winter',
                    'kenmerken' => 'Gele bloemetjes op kale takken, bloeit vaak al in de winter',
                    'locatie' => 'Tuinen, parken, langs muren en schuttingen',
                    'feitje' => 'Winterjasmijn bloeit soms al als er nog sneeuw ligt!',
                    'question' => 'Wanneer bloeit winterjasmijn meestal?',
                    'correct' => 'In de winter',
                    'wrong1' => 'In de zomer',
                ...
                [
                    'title' => 'Sneeuwklokje',
                    'category' => 'Bloem',
                    'season_text' => 'Winter en vroege Lente',
                    'kenmerken' => 'Witte hangende bloemetjes, vaak één van de eerste bloemen van het jaar',
                    'locatie' => 'Parken, tuinen, bosranden',
                    'feitje' => 'Sneeuwklokjes kunnen door koude grond heen groeien.',
                    'question' => 'Welke kleur hebben de bloemen van een sneeuwklokje?',
                    'correct' => 'Wit',
                    'wrong1' => 'Rood',
                    'wrong2' => 'Blauw',
                    'seasons' => ['Winter', 'Lente'],
                ],
                [
                    'title' => 'Hulst',
                    'category' => 'Boom',
                    'season_text' => 'Alle seizoenen',
                    'kenmerken' => 'Groene stekelige bladeren en vaak rode bessen',
                    'locatie' => 'Bossen, tuinen en parken',
                    'feitje' => 'Hulst blijft in de winter groen: een echte winterplant.',
                    'question' => 'Wat is typisch aan de bladeren van hulst?',
                    'correct' => 'Ze zijn stekelig',
                    'wrong1' => 'Ze zijn helemaal rond en zacht',
                    'wrong2' => 'Ze zijn altijd geel',
                    'seasons' => ['Lente', 'Zomer', 'Herfst', 'Winter'],
                ],
                [
                    'title' => 'Maretak',
                    'category' => 'Plant',
                    'season_text' => 'Winter',
                    'kenmerken' => 'Groeit als een bolvormige kluwen in bomen, heeft witte besjes',
                    'locatie' => 'In bomen (zoals populieren en appelbomen)',
                    'feitje' => 'Maretak is een halfparasiet: hij haalt water en voeding uit de boom.',
                    'question' => 'Waar groeit maretak meestal?',
                    'correct' => 'In bomen',
                    'wrong1' => 'Onder water',
                    'wrong2' => 'Alleen op zandduinen',
                    'seasons' => ['Winter'],
                ],
                [
                    'title' => 'Winterakoniet',
                    'category' => 'Bloem',
                    'season_text' => 'Winter en vroege Lente',
                    'kenmerken' => 'Kleine gele bloemetjes, laag bij de grond',
                    'locatie' => 'Tuinen, parken, bosranden',
                    'feitje' => 'Winterakoniet kan al bloeien terwijl veel andere planten nog “slapen”.',
                    'question' => 'Welke kleur heeft de bloem van winterakoniet meestal?',
                    'correct' => 'Geel',
                    'wrong1' => 'Paars',
                    'wrong2' => 'Zwart',
                    'seasons' => ['Winter', 'Lente'],
